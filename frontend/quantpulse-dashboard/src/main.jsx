...
const importCoinPulsePage = () => import("./pages/CoinPulsePage");
...
const CoinPulsePage = React.lazy(importCoinPulsePage);
...
function getPageFromPath(pathname) {
  ...
  if (path.startsWith("/coin-pulse")) return "coin-pulse";
...
function buildPageUrl(page, view) {
  ...
  if (page === "coin-pulse") return `/coin-pulse?${params.toString()}`;
...
function normalizeAutoSettings(value) {
  const defaults = {
    ...
    maxLeverage: 5,
    maxPositionSize: 170000,
    paperCapitalInr: 200000,
  ...
  return {
    ...
    maxRiskPerTradeEnabled: Boolean(value.maxRiskPerTradeEnabled),
    ...
    dailyLossLimitEnabled: Boolean(value.dailyLossLimitEnabled),
    maxOpenTradesEnabled: Boolean(value.maxOpenTradesEnabled),

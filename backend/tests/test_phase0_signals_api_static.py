...
class Phase0SignalsApiStaticTests(unittest.TestCase):
    def test_signals_endpoint_is_not_hardcoded_wait(self):
        ...
        self.assertIn('"scalp": ["1h", "2h", "4h", "1d"]', source)
        self.assertIn('"swing": ["1h", "2h", "4h", "1d"]', source)
        self.assertIn('"position": ["1h", "2h", "4h", "1d"]', source)
        ...
        self.assertIn("The governed prediction stack is fixed", source)
